...
<header>
  <h1 class="main"><a href="#" style="position: absolute;top:30px;">ex01_oracle_input HOme</a></h1>
  <ul>
    <li><a href="#">로그인</a></li>
    <li><a href="#">회원가입</a></li>
  </ul>
...
<div>
  ...
  <div id="map" style="width: 100%; height: 500px;"></div>	<!-- 지도가 출력될 캔버스 -->
</div>
