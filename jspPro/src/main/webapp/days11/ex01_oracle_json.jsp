...
<header>
  <h1 class="main"><a href="#" style="position: absolute;top:30px;">ex01_oracle_json HOme</a></h1>
  <ul>
    <li><a href="#">로그인</a></li>
    <li><a href="#">회원가입</a></li>
  </ul>
...
<script>
   ...
   var markers = [];	//에이작스로 마크 정보를 얻어와서 마크를 선언된 ㅂ ㅐ열에 추가하겠다
   var customLabel = {
         restaurant:{
            label: 'R'
         }
...
<script async="true" defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA_e_mLplWHzp6nDkHS6bXvm8UEu_Fimxs&callback=myMap"></script>
