 ...
 * Generated at: 2024-10-17 00:32:02 UTC
...
//int num = request.getParameter("num")==null?0:Integer.parseInt(request.getParameter("num"));
      ...
      out.write("  ");
      out.write("\r\n");
      out.write("  정수 : <input type = \"text\" id= \"num\" name=\"num\" autofocus><br>\r\n");
      out.write("  <!-- </form> -->\r\n");
      out.write("  \r\n");
      out.write("  <!-- 숫자만 입력되게, 유효성검사  엔터를 칠때 '3' 입력시 1+2+3-->\r\n");
      out.write("  \r\n");
      out.write("<p id=\"demo\">\r\n");
      out.write(" ");
 ...
 if(pNum != null){
  ...
  for(int i=1; i<=num; i++){
      ...
      out.write("	          )){\r\n");
      out.write("			  alert(\"숫자만 입력\")\r\n");
      out.write("			  e.preventDefault();\r\n");
      out.write("		  }//if\r\n");
      out.write("	  },\r\n");
      out.write("	  \"keyup\": function(event) {\r\n");
      out.write("		  //if($(\"num\").val().length != 0 && event.which == 13){	//입력이 된 상태\r\n");
      out.write("			  if( event.which == 13){	//입력이 된 상태\r\n");
      out.write("			  \r\n");
      out.write("			  //$(\"form\").submit();\r\n");
      out.write("			  let numValue = $(\"#num\").val();\r\n");
      out.write("			location.href = `ex03_06.jsp?num=${numValue}`;	//무조건 get방식\r\n");
      out.write("		  }\r\n");
      out.write("	  }\r\n");
      out.write("  })\r\n");
      out.write("  .select()\r\n");
