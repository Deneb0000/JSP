 ...
 * Generated at: 2024-10-17 10:15:30 UTC
...
String contextPath = request.getContextPath();
  ...
  while (dir.hasNext()) {
      ...
      out.write("\r\n");
      out.write("      <!-- p_deptno 값이 현재 옵션의 deptno와 같으면 selected -->\r\n");
      out.write("      <option value=\"");
      out.print( deptno );
      out.write('"');
      out.write(' ');
      out.print( (p_deptno == deptno) ? "selected" : "" );
      out.write('>');
      out.print( dname );
      out.write("</option>\r\n");
      out.write("  ");
      ...
      out.write("\r\n");
      out.write("  		<tr>\r\n");
      out.write("  			<td colspan =\"8\"> 사원이 존재 </td>  		\r\n");
      out.write("  		</tr>\r\n");
      out.write("  		");
      ...
      out.write("	    if(deptno) {\r\n");
      out.write("	        // contextPath로 이동하고 deptno 값을 URL 파라미터로 전달\r\n");
      ...
      out.write("\r\n");
      out.write("  <script>\r\n");
      out.write("  //모두선택 체크박스 이벤트\r\n");
      out.write("  /* $(\"#ckbAll\").on(\"click\", function(event) {\r\n");
      out.write("	  //$(this).prop(\"checked\"); 체크 속성 가져오기\r\n");
      ...
      out.write("});\r\n");
      out.write("\r\n");
      out.write("//각 사원들의 체크박스를 클릭할때 모두 선택 체크박스 처리\r\n");
      out.write("/* $(\"table tbody tr\")\r\n");
      ...
      out.write("}); */\r\n");
      out.write("$(\"table\").on(\"click\", \"tbody tr td:first-child :checkbox\", function() {\r\n");
      out.write("    let ck = $(\"tbody :checkbox\").length === $(\"tbody :checkbox:checked\").length;\r\n");
      out.write("    $(\"#ckbAll\").prop(\"checked\", ck);\r\n");
      out.write("});\r\n");
      out.write("  </script>\r\n");
      ...
      out.write("		//두번째 풀이\r\n");
      out.write("		$(\"tfoot button\").on(\"click\", function(event) {\r\n");
      out.write("			//ex01_ok.jsp?empno=111&~\r\n");
      out.write("					let empnos = [];\r\n");
      out.write("					$(\"tbody :checkbox:checked\").each(function( index, element) {\r\n");
      out.write("						\r\n");
      out.write("						//ㅓ쿼리 메소드 : data() 		data-empno\r\n");
      out.write("						let empno =	$(element).data(\"empno\")\r\n");
      out.write("						empnos.push(empno)\r\n");
      out.write("					});\r\n");
      out.write("		  			location.href = `ex01_ok.jsp?empnos=${empnos.join(\"&empno=\")}`;\r\n");
      out.write("			\r\n");
      out.write("		})\r\n");
      out.write("  		</script>\r\n");
      out.write("</body>\r\n");
